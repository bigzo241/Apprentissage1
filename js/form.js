//Fonction de desactivation de l'affichage des "tooltips"
...
var check = {}; //On met toute nos fonctions dans un objet litteral
...
check['age'] = function(){
    ...
    if(!isNaN(ageValue) && ageValue>= 5 && ageValue<=150){
